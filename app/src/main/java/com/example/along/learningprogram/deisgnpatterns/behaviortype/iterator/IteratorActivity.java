package com.example.along.learningprogram.deisgnpatterns.behaviortype.iterator;
...
public class IteratorActivity extends BaseActivity{
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_iterator;
    }
}
