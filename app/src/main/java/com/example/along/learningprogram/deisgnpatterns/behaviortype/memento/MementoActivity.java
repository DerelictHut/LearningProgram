package com.example.along.learningprogram.deisgnpatterns.behaviortype.memento;
...
public class MementoActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_memento;
    }
}
