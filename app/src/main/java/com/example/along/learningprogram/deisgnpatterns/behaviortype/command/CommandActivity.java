package com.example.along.learningprogram.deisgnpatterns.behaviortype.command;
...
public class CommandActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_command;
    }
}
