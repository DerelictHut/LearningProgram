package com.example.along.learningprogram.deisgnpatterns.behaviortype.interpreter;
...
public class InterpreterActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_interpreter;
    }
}
