package com.example.along.learningprogram.deisgnpatterns.behaviortype.chainofresponsibility;
...
public class ChainOfResponsibilityActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_chain_of_responsibility;
    }
}
