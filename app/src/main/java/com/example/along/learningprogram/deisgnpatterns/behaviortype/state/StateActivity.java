package com.example.along.learningprogram.deisgnpatterns.behaviortype.state;
...
public class StateActivity extends BaseActivity{
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_state;
    }
}
