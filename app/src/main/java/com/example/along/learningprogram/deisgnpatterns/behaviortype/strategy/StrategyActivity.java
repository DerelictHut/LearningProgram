package com.example.along.learningprogram.deisgnpatterns.behaviortype.strategy;
...
public class StrategyActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_strategy;
    }
}
