package com.example.along.learningprogram.deisgnpatterns.behaviortype.mediator;
...
public class MediatorActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_mediator;
    }
}
