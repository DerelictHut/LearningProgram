package com.example.along.learningprogram.deisgnpatterns.behaviortype.observer;
...
public class ObserverActivity extends BaseActivity {
    ...
    protected int getLayoutId(Bundle savedInstanceState) {
        return R.layout.deisgnpatterns_activity_observer;
    }
}
